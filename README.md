...
I'm a full-stack software engineer based in the Philippines, building products across the web, services, and tooling. I treat AI agents and automation as first-class collaborators in the development loop — designing systems where intelligent workflows aren't bolted on, but built in from the start.
